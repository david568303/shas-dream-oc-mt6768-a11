...
from data.ClkData import ClkData, OldClkData, NewClkData
from utility.util import log, LogLevel, sorted_key
...
class ClkObj_MT6757(ClkObj_MT6797):
    ...
    def get_cfgInfo(self):
        super.get_cfgInfo(self)

    def parse(self, node):
        super.parse(self, node)

    def gen_files(self):
        super.gen_files(self)
